(function ($) {
    ...
    var _prefix = (function (temp) {
        var aPrefix = ['webkit', 'moz', 'o', 'ms'],
            props = '';
        for (var i = 1, len = aPrefix.length; i <= len; i ++) {
    ...
    var XSwitch = (function () {
        ...
        function _initPaging(_this) {
            ...
            _this.activeClass = _this.selectors.active.substring(1);
                pageHtml +='<div class="pages-nav"></div>';
            for (var i = 1, len = _this.pagesCount; i <= len; i ++) {
                pageHtml += '<li>'+'<p class="name fl"></p>'+'<p class="number fr">0'+i+'</p>'+'</li>';
            }
            pageHtml += '</ul>';
