    ...
    $.fn.fullpage = function(options) {
        ...
        */
        function addVerticalNavigation(){
            $body.append('<div id="' + SECTION_NAV + '"><div class="f-title"></div><div class="pages-nav"></div><ul></ul></div>');
            ...
            for (var i = 0; i < $(SECTION_SEL).length; i++) {
                ...
                i=i+1;
                var li = '<li><a href="#' + link + '"><p class="name hvr-wobble-skew fl"></p><span></span><p class="number fr">'+'0'+i+'</p></a>';
